...
cleanly where the naive sampler (Algorithm 1) accumulates errors.

## 2. Chosen Result

Two results, both on CIFAR-10:
...
# Or the blur task
python -m src.training.train --degradation blur --total-steps 60000
